...
import me.tastybulb.asylum.api.utils.font.FontUtils;
...
public class ClickGui extends MinecraftHUDGUI {
    ...
    public ClickGui() {
        ...
        theme = new AsylumTheme(new SettingsColorScheme(clickGui.enabledColor, clickGui.backgroundColor, clickGui.settingBackgroundColor,
