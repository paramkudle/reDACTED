...
import static me.tastybulb.asylum.api.utils.BlockUtils.faceVectorPacketInstant;

import me.tastybulb.asylum.api.utils.BlockUtils;
...
public class Surround extends Module {
    ...
    public BooleanSetting shiftOnly = new BooleanSetting("OnCrouch", this, false);
    public BooleanSetting rotate = new BooleanSetting("AutoRotate", this, true);
    public BooleanSetting disableOnJump = new BooleanSetting("DisableWhenJump", this, false);
    ...
    public NumberSetting timeOutTicks = new NumberSetting("TimeOutTick", this, 40, 1, 100, 10);
    public NumberSetting blocksPerTick = new NumberSetting("BlocksPerTick", this, 4, 0, 8, 1);

    public Surround() {
        super ("Surround", "Surrounds your feet", Keyboard.KEY_NONE, Category.COMBAT);
